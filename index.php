<?php
   ...
   $imagenes=ListaImagenCategorias();
   $fondo = bgDinamic();
...
<body>
    ...
    <div id="page" class="page">
        ...
        <section class="position-relative padding-40px-tb offer
                ...
                xs-padding-50px-tb" id="callto-action8" data-img-size="(W)1920px
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center
                        ...
                        <div class="offer-box-left">
                            <span class="title-extra-large-2
                                    ...
                                    xs-margin-thirteen-bottom">Design for your
                                satisfaction!</span>
        ...
        <section class="productos-section" id="productos-section">
            <h3 style="text-align: center; margin-bottom: 40px;">Productos de Todas las categorias</h3>
            <div class="container-products">
                <?php  foreach($imagenes as $key=>$val) : ?>
                <!--INICIO CARD-->
                <div class="card">
                    <a href="categoria.php?id=<?= $val["id"] ?>&titulo=<?= $val["title"] ?>">
                        <div class="image">
                            <img src="<?= $val["url"] ?>" alt="">
                        </div>
                        <div class="info">
